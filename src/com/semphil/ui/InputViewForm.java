...
public class InputViewForm extends JDialog {
	...
	public static void main(String[] args) {
		try {
			InputViewForm dialog = new InputViewForm();
	...
	public InputViewForm() {
		...
		}
		{
			...
			}
			{
				...
				btnExit.setFont(new Font("Helvetica LT Std", Font.PLAIN, 13));
